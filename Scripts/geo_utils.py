...
def calculate_great_circle_distance(
    ...
    origin_lat_rad = degrees_to_radians(origin_lat_deg)
    origin_lon_rad = degrees_to_radians(origin_lon_deg)
    dest_lat_rad = degrees_to_radians(dest_lat_deg)
    dest_lon_rad = degrees_to_radians(dest_lon_deg)
    # Calculate distance
...
def calculate_initial_bearing(
    ...
    bearing_deg = (radians_to_degrees(theta) + 360) % 360
    return bearing_deg
...
def determine_destination_coords(
    ...
    origin_lat_rad = degrees_to_radians(origin_lat_deg)
    origin_lon_rad = degrees_to_radians(origin_lon_deg)
    bearing_rad = degrees_to_radians(initial_bearing_deg)
    ...
    dest_lat_deg = radians_to_degrees(dest_lat_rad)
    dest_lon_deg = radians_to_degrees(dest_lon_rad)
...
def determine_square_coords(
    ...
    for angle_rad in angle_rad_list:
        ...
        latlon_list = determine_destination_coords(
            ...
            initial_bearing_deg=radians_to_degrees(bearing_rad),
        )
